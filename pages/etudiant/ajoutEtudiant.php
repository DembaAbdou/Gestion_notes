<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $req2 = $pdo->prepare("INSERT INTO etudiants(prenom, nom, dateNais, adresse, telephone, photo, formation_id, comptes_id) VALUES(?, ?, ?, ?, ?, ?, ?, ?)");
    $params2 = array($prenom, $nom, $dateNais, $adresse, $telephone, $nomPhoto, $formation_id, $compte_id);
